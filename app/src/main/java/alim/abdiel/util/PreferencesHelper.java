package alim.abdiel.simpleapplication.util;
...
public class PreferencesHelper {
    ...
    public static alim.abdiel.simpleapplication.util.PreferencesHelper getInstance (Context context){
        if (INSTANCE == null){
            INSTANCE = new alim.abdiel.simpleapplication.util.PreferencesHelper(context);
        }
        return INSTANCE;
    }
